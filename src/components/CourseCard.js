...
export default function CourseCard() {
    const courses = [{
        ...
        description: "Git introduction course, command line, git commands, github introduction, merges, and conflict resolution."
    }, {
        name: "React + Redux",
        institution: "Udemy",
        ...
        description: "React course with Redux, Webpack, full-stacks application development, react componentization and good development practices."
    }, {
        ...
        description: "Javascript course from basic to advanced, object orientation, web programming with Node, programming logic, regular expressions, events and DOM."
    },
    //     {
        ...
        <>
            {courses.map(item =>
                <StyledCourseDiv link={item.hasLink} href={item.link} target="_blank">
                    ...
                    <StyledLabel noSpace responsive>{item.institution}</StyledLabel>
