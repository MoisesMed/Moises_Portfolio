    ...
    return (
        <Container className="containerSobre" id="sobre">
            <Col>
                ...
                <Row className="textoSobre"><text>"Meu nome é Moisés Medeiros Matos, tenho 22 anos e faço faculdade de Sistemas da Informação. Sou desenvolvedor Web e Mobile, técnico de informática e amante de tecnologia</text></Row>
