                    ...
                    <Row className="rowCard">
                        ...
                        <Col style={{ padding: 0, margin: 0, borderLeft: "2px solid white" }}>
                            ...
                            <Row className="buttonRow">
                                <Col>
                                    <Button className="buttonLeft" style={{ width: "45%", marginRight: 10, fontSize: 12, backgroundColor: "cornflowerblue", border: "0px", padding: 3, margin: 0 }}>Ver credencial</Button>
                                    <Button className="buttonRight" style={{ width: "43%", marginLeft: 10, fontSize: 12, backgroundColor: "cornflowerblue", border: "0px", padding: 3, margin: 0 }}>Ver conteúdo</Button></Col>
                            </Row>
                        </Col>
                    </Row>
                )}
